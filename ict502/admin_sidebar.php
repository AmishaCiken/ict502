...
<div class="bg-sidebar vh-100 w-50 position-fixed" id="sidebar">
    ...
    <div class="bg-list d-flex flex-column align-items-center fw-bold gap-2 mt-4">
        <ul class="d-flex flex-column list-unstyled">
            <li class="h7">
                <a class="nav-link text-dark" href="admin_availablefarm.php">
                    <i class="fal fa-home-lg-alt me-2"></i> <span>Available Farm</span>
                </a>
            </li>
            <li class="h7">
                <a class="nav-link text-dark" href="admin_bookingFarm.php">
                    <i class="fal fa-bookmark me-2"></i> <span>Booking Farm</span>
                </a>
            </li>
            <li class="h7">
                <a class="nav-link text-dark" href="admin_AddTool.php">
                    <i class="far fa-graduation-cap me-2"></i> <span>Add Tools</span>
                </a>
            </li>
            <li class="h7">
                <a class="nav-link text-dark" href="admin_tool.php">
                    <i class="fal fa-sliders-v-square me-2"></i> <span>Manage tool</span>
                </a>
            </li>
            <li class="h7">
                <a class="nav-link text-dark" href="admin_animal.php">
            ...
            <li class="h7">
                <a class="nav-link text-dark" href="admin_crop.php">
                    <i class="fal fa-file-chart-line me-2"></i> <span>Crops</span>
                </a>
            </li>

            <li class="h7">
                <a class="nav-link text-dark" href="admin_crop_produce.php">
